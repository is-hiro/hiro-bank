...
export class StatisticsItem extends ChildComponent {
	...
	render() {
		...
		$H(this.element).addClass(styles[this.variant]).addClass('fade-in')
		$H(this.element).find('#statistic-label').text(this.label)
		$H(this.element).find('#statistic-value').text(this.value)
